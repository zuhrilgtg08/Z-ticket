        ...
        <div class="card shadow-inner border-0">
            <div class="card-header mt-3">
                <div class="row justify-content-between">
                    <div class="col-md-8">
                        <h2 class="h2 text-black-50">Create Hotel</h2>
                    </div>
                    <div class="col-md-4">
            ...
            <div class="card-body">
                <form action="{{ route('data_hotel.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('nama_hotel') is-invalid @enderror" name="nama_hotel"
                                    type="text" id="nama_hotel" value="{{ old('nama_hotel') }}" required />
                                @error('nama_hotel')
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('harga_hotel') is-invalid @enderror" name="harga_hotel"
                                    type="number" id="harga_hotel" value="{{ old('harga_hotel') }}" min="1" required />
                                @error('harga_hotel')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control-file @error('image_hotel') is-invalid @enderror" name="image_hotel"
                                    type="file" id="image_hotel" value="{{ old('image_hotel') }}" onchange="imagePreview()" />
                                @error('image_hotel')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="tiket_id" id="tiket_id"
                                    class="form form-select @error('tiket_id') is-invalid @enderror data-tiket" required>
                                    <option value="" selected disabled>Pilih Tiket</option>
                                    @foreach ($tikets as $data)
                                        <option value="{{ $data->id }}">{{ $data->nama_tiket }}</option>
                                    @endforeach
                                </select>
                                @error('tiket_id')
                                <div class="invalid-feedback">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="hidden" class="form-control @error('deskripsi_hotel') is-invalid @enderror"
                            id="deskripsi_hotel" name="deskripsi_hotel" required value="{{ old('deskripsi_hotel') }}">
