        ...
        <div class="card shadow-inner border-0 h-100">
            <div class="card-header mt-3">
                <div class="row justify-content-between mb-3">
                    <div class="col-md-8">
                        <h2 class="text-black-50">Create Kategori</h2>
                    </div>
                    <div class="col-md-4">
            ...
            <div class="card-body">
                <form action="{{ route('data_categories.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label for="nama_kategori" class="form-label">Nama Kategori : </label>
                        <input class="form-control @error('nama_kategori') is-invalid @enderror" name="nama_kategori"
                            type="text" id="nama_kategori" value="{{ old('nama_kategori') }}" required />
                        @error('nama_kategori')
