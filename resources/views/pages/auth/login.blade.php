            ...
            <div class="col-lg-6 col-xl-4 offset-xl-1 mb-5">
                <form action="{{ route('login.process') }}" method="POST" class="d-inline">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" id="email" class="form-control form-control-lg" placeholder="Akun Email" autocomplete="off"
                    ...
                    <div class="text-center text-center mt-3 pt-2">
                        ...
                        <h6 class="fw-normal mt-2 pt-1 mb-0">Belum punya akun?
                            <a href="{{ url('register') }}" class="link-danger text-decoration-none fw-bold">Daftar Disini!</a>
                        </h6>
                    </div>
                </form>
            </div>
