...
<html lang="en">
    ...
    <body>
        <div class="container mt-4 border-1 border-secondary rounded">
            <main class="py-4">
                <div class="my-5 text-center mb-5">
                    <h3 class="text-primary">Detail Your Order</h3>
                </div>
                                ...
                                <div class="container">
                                    ...
                                    <div class="row">
                                        <ul class="list-unstyled">
                                            <li class="text-black">Nama : {{ Auth::user()->username }}</li>
                                            ...
                                            <div class="col-md-8 text-end">
                                                <ul class="list-unstyled">
                                                    <li class="text-black mt-2">
                                                        <h3 class="text-success fw-bold">Total : @harga($total)</h3>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
